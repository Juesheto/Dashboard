...
app.layout = html.Div([
    ...
    html.Div([
        html.P("Este tablero interactivo permite explorar tendencias de canciones populares de Spotify entre 2010 y 2023. Puedes filtrar por fechas, años y categorías clave como modo musical o artistas más escuchados."),
        html.Label("Tema visual:"),
        dcc.RadioItems(
            id='theme_selector',
            options=[
...
def update_histogram(start, end):
    ...
    if filtered.empty:
        fig = go.Figure()
        fig.add_annotation(text="No hay datos para este rango.",
                           x=0.5, y=0.5, showarrow=False)
        return fig
...
# Nota: Ejecutar con app.run_server(debug=True) localmente
app.run(debug=True)
